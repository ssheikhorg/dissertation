...
from bleurt import finetune, score

flags = tf.flags
FLAGS = flags.FLAGS


references = ["An apple a day keeps the doctor away.", "An apple a day keeps the doctor away."]
candidates = ["An apple a day keeps the doctor away.", "An apple a day keeps doctors away."]
