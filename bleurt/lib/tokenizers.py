...
class WordPieceTokenizer(Tokenizer):
    ...
    def __init__(self, vocab_file, do_lower_case):
        ...
        self._tokenizer = bert_tokenization.FullTokenizer(vocab_file=vocab_file, do_lower_case=do_lower_case)
...
class SentencePieceTokenizer(Tokenizer):
    ...
    def __init__(self, sp_model):
        ...
        logging.info(f"Will load model: {self._sp_model_path}.")
...
def create_tokenizer(vocab_file=None, do_lower_case=None, sp_model=None):
    ...
    if vocab_file and do_lower_case is not None:
        ...
        raise ValueError("Cannot determine the type of Tokenizer to build from arguments.")
